...
namespace DreamSoccer.Repository.Migrations
{
    ...
    [Migration("20210208165436_CreateTransferList")]
    partial class CreateTransferList
    {
            ...
            modelBuilder.Entity("DreamSoccer.Core.Entities.Player", b =>
                {
                    ...
                    b.HasOne("DreamSoccer.Core.Entities.TransferList", "TransferList")
                        .WithOne("Player")
                        .HasForeignKey("DreamSoccer.Core.Entities.Player", "TransferListId")
                        .OnDelete(DeleteBehavior.Restrict);
